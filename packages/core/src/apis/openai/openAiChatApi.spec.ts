...
describe("OpenAiChatApi.requestTemplate", () => {
  /**
  ...
  test("prompt, examplePairs", () => {
    ...
    expect(rendered).toEqual({
      ...
      messages: [
        {
          role: "user",
          content: "mock-user-msg-1",
        },
        {
          role: "assistant",
          content: "mock-assistant-msg-1",
        },
        {
          role: "user",
          content: "mock-user-msg-2",
        },
        {
          role: "assistant",
          content: "mock-assistant-msg-2",
        },
        {
          role: "user",
          content: "mock-prompt",
